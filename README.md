...
- **[ProteinClaw](https://github.com/shuaizengMU/ProteinClaw)** - TypeScript / Python - Conversational AI agent that unifies protein research databases into a single natural-language interface, automatically chaining tools across annotation, structure, variants, pathways, and more to synthesize answers.
