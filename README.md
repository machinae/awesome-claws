...
- **[CorvinOS](https://github.com/CorvinLabs/CorvinOS)** - Python - Self-hosted agentic OS connecting local (Ollama) and cloud models to Discord, Telegram, WhatsApp, Slack, and Email, with EU AI Act 2026 and GDPR compliance built structurally into the architecture (hash-chained audit log, deny-by-default consent, Art. 17 erasure orchestrator).
