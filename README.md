...
- **[SkillClaw](https://github.com/AMAP-ML/SkillClaw)** - Python - Collective skill evolution for OpenClaw-style agents: a client API proxy records sessions, evolve servers distill experience into shared Skills (OSS/S3/local), with native integration for related stacks.
