...
- **[NarraNexus](https://github.com/NetMindAI-Open/NarraNexus)** - Python / TypeScript - Ready-to-run AI agent team workspace by NetMind.AI. Persistent memory, multi-agent collaboration (PM/dev/deployment/research), MCP-style tool integrations, and composable modules.
